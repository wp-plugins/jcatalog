...
require_once dirname(__FILE__) . DS . 'Serializer.php';
require_once dirname(__FILE__) . DS . 'Unserializer.php';
	...
	{	
		...
		try
		{
			...
			if($res)
			{
				...
				{
					$isSOAPFault = true;
					$soapFault = null; 	//new FaultMessage();
					$errorData = null;	//new ErrorData();
