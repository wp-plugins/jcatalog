...
$myentry->link=htmlentities( $myentry->link );


						 				$this->_createEntry( $rss, $myentry->title, $myentry->content, $myentry->link, $myentry->published, $myentry->updated, $imagePath);
