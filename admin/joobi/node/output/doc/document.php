...
class Output_Doc_Document {
	...
	public static function loadListingElement(&$listing){
		...
		if( ! method_exists( 'WView', 'includeElement')) return false;
	...
	public function callListingElement(&$listing,&$row,$function='make'){
		...
		if( isset($this->htmlObj->btntsk)) $colum->btntsk=$this->htmlObj->btntsk;
		if( isset($this->htmlObj->btnn)) $colum->btnn=$this->htmlObj->btnn;
