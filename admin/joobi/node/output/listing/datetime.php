...
class WListing_Coredatetime extends WListings_default{
	...
	private function _renderDateFormHTML($lid,$text){
		...
		if( !empty($this->element->resetbutton)){
			...
			$html .=' <a class="calendarDashReset" href="#" alt="'.$altText.'" title="'.$altText.'" onclick="'.$replace.'; return false;"><img src="'. JOOBI_URL_JOOBI_IMAGES . 'toolbar/16/cancel.png" border="0"/></a>';
		}
		return $html;
