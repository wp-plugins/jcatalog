...
public function addSender($email,$name=''){
  ...
  public function address($email,$name=''){
  	$this->_addEmailAddress( $email, $name, 'AddAddress' );
  }
  ...
  public function replyTo($email,$name=''){
  	$this->_addEmailAddress( $email, $name, 'AddReplyTo' );
  }
  ...
  public function CC($email,$name=''){
	$this->_addEmailAddress( $email, $name, 'AddCC');
  }
  ...
  public function BCC($email,$name=''){
  		$this->_addEmailAddress( $email, $name, 'addBCC');
  }
...
public function getTextBody($text){
  ...
  private function _addEmailAddress($email,$name='',$function){
