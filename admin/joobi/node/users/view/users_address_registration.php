...
private function _setProcessTail(){	
	...
	$basketTailC=WClass::get( 'basket.tail' , null, 'class', false );

	if( $basketTailC ) $processTail=$basketTailC->display( 2 );	
	else {

		$message=WMessage::get();


		$message->codeE( 'Class basket_tail does not exist, trace function _setProcessTail' );
