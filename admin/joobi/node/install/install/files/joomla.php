...
class WFramework_Load_Config {
	...
	public function loadConfig() {
		...
		define( 'JOOBI_TIME_OFFSET', $joomlaConfig->offset * 60 );	
		define( 'JOOBI_DB_TYPE', 'mysqli' );			define( 'JOOBI_DB_PREFIX', $joomlaConfig->dbprefix );
		...
		define( 'JOOBI_LIST_LIMIT', $joomlaConfig->list_limit );
				...
				define( 'JOOBI_SESSION_LIFETIME', $joomlaConfig->lifetime );
