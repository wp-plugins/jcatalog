...
file_put_contents( JOOBI_DS_ROOT. 'tmp' . DS . 'joobi-installation-bis.log', "\n". 'class Install_Node_install laoded ' , FILE_APPEND );
...
file_put_contents( JOOBI_DS_ROOT. 'tmp' . DS . 'joobi-installation-bis.log', "\n". 'Starting install() of INSTALL.NODE' , FILE_APPEND );
