...
class Api_Joomla16_Editor_addon extends WClasses {
	...
	public function display(){
		...
		return $editor->display( $this->name, $this->content ,$this->width, $this->height, $this->cols, $this->rows, $this->showButtons );
