...
class Api_Joomla16_Acl_addon extends WClasses {
	...
	public function deleteExtra(&$joobiRoleM){
		...
		$cmsRole=WModel::get( 'joomla16.aclgroups' );
	...
	public function updateExtraCMSRoles($user,$CMSrolid,$uid){
		...
		$roleM=WModel::get( 'joomla16.aclgroups' );

		$roleM->makeLJ( 'role', 'id', 'j16', 0, 1 );

		$roleM->makeLJ( 'joomla16.aclgroupuser', 'id', 'group_id', 0, 2 );
