...
class Files_Scripts_type extends WTypes {
...
<object id=\"{ID}\" type=\"application/x-shockwave-flash\" style=\"width:{WIDTH}px;height:{HEIGHT}px;\" data=\"{URLINC}main/mediaplayer/allplayer.swf\" title=\"{NAME}\">

<param name=\"movie\" value=\"{URLINC}main/mediaplayer/allplayer.swf\" />
...
<embed src=\"{FILESOURCE}\" width=\"{WIDTH}\" height=\"{HEIGHT}\" name=\"{ID}\" CONTROLLER=\"false\" bgcolor = \"{BACKGROUND}\" quality =\"Best\" allowfullscreen=\"true\" wmode = \"{TRANSPARENCY}\" allowscriptaccess=\"always\">
