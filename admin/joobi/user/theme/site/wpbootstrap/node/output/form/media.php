...
dropArea:'#drophere_".self::$_countUploads."',";
				...
				$this->content .= '<div  class="drophere" id="drophere_'.self::$_countUploads.'">' . WText::t('1418159379KSUW') . '<br/><i class="fa fa-cloud-download fa-4x"></i>';
		...
		if ( $this->_maxFiles < 2 ) {
				...
				if ( $mimeA[0]=='image' && !$myFileInfoO->secure ) {
					...
					$this->content .=  '<div style="float:left; clear:both;"><div><strong>'.WText::t('1298350386KTQN').$startLink.'</strong></div>';
