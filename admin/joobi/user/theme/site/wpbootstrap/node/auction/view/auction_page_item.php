...
<?php endif; ?>
			...
			<div id="siteContent" class="col-md-<?php echo $colWith; ?>">
				...
				<?php endif; ?>
					...
					<?php $showBiddingDetails = $this->getvalue('showbiddingdetails'); ?>
					<div id="siteAuction">
						<div id="cartContainer">
							<table class="auction" style="text-align: left; width: 100%;" border="0" cellpadding="5px" cellspacing="2">
								<tbody>
									<tr>
										<td id="auctionBidDate" style="width:30%; vertical-align: top;"><?php echo $this->getValue( 'biddingdatetitle' ); ?></td>
										<td id="auctionBidDateDetail" style="vertical-align: top;"><?php echo $this->getValue('biddingdate'); ?></td>
									</tr>
									<?php if ( $bidCount = $this->getContent('bidcount') ) : ?>
									<tr>
										<td id="auctionBidCount" style="vertical-align: top;"><?php echo $this->getTitle('bidcount'); ?></td>
										<td id="auctionBidCountDetail" style="vertical-align: top;"><?php echo $bidCount; ?></td>
									</tr>
									<?php endif; ?>
										<tr>
											<td id="auctionBidValue" style="vertical-align: top;"><?php echo $this->getValue( 'showbidtitle' ); ?></td>
											<td id="auctionBidValueDetail" style="vertical-align: top;"><span><?php echo $this->getValue('showbid'); ?></span></td>
										</tr>
									<?php if ( !$this->getValue( 'winbid' ) ) : ?>
										<?php if ( $approxateText = $this->getRowContent('approximatebid') ) : ?>
										<tr>
											<td id="auctionApproxBid" style="vertical-align: top;"></td>
											<td id="auctionApproxBidDetail" style="vertical-align: top;"><?php echo $approxateText; ?></td>
										</tr>
										<?php endif; ?>
										<?php $placeBidButton = $this->getRowContent('placebid'); ?>
										<?php if ( $showBiddingDetails ) : ?>
										<tr>
											<td id="auctionBid" style="vertical-align: top;"><?php echo $this->getTitle('itembidbox'); ?></td>
											<td id="auctionBidDetail" style="vertical-align: middle;">
												<div class="auctionPlaceBidBox"><?php echo $this->getRowContent('itembidbox'); ?></div>
												<div class="auctionPlaceBidBttn"><?php echo $placeBidButton; ?></div>
											</td>
										</tr>
										<?php endif; ?>
										<?php if ( $placeBidButton && $showBiddingDetails ) : ?>
										<tr>
											<td id="auctionNotice" style="vertical-align: top;"></td>
											<td id="auctionNoticeDetail" style="vertical-align: top;"><?php echo $this->getRowContent('bidnotice'); ?></td>
										</tr>
										<?php endif; ?>
										<?php
										$itemPrice = $this->getRowContent('itemprice');
										if ( $showBiddingDetails && !empty($itemPrice) && '<div></div>' != $itemPrice ) : ?>
										<tr>
											<td id="auctionBuyNowPrice" style="vertical-align: top;"><?php echo $this->getTitle('itemprice'); ?></td>
											<td id="auctionBuyNowButton" style="vertical-align: top;"><span><?php echo $itemPrice; ?></span><div class="auctionBuyNowBttn"><?php echo $this->getRowContent('addtocart'); ?></div></td>
										</tr>
										<?php endif; ?>
									<?php endif; ?>
									...
									<tr>
										<td > </td>
										<td id="auctionShippingMessage" style="vertical-align: top;"><div id="siteShipping"><?php echo $shippingMethod; ?></div></td>
									</tr>
									<?php endif; ?>

									<?php if ( !$this->getValue( 'winbid' ) && $auctionFee = $this->getValue('auctionFeePrice') ) : ?>
									<tr>
										<td id="auctionFeeText" style="vertical-align: top;"><?php echo $this->getValue('auctionFeeText'); ?></td>
										<td id="auctionFeePrice" style="vertical-align: top;"><div id="auctionFee"><?php echo $auctionFee; ?></div></td>
									</tr>
									<?php endif; ?>
