...
<?php endif; ?>
			...
			<div id="siteContent" class="col-md-<?php echo $colWith; ?>">
				...
				<?php if ( $pageParams->showPrice ) :
					...
					$itemPrice = $this->getRowContent( $this->getValue( 'itemprice' ) );
				...
				<?php if ( $pageParams->showCartButton && $addToCart = $this->getRowContent('makeoffer') ) : ?>
				...
				<?php if ( $classifiedCountDown = $this->getValue('classifiedCountDown') ) : ?>
					<div id="siteCountDown">
						<?php echo $classifiedCountDown; ?>
					</div>
				<?php endif; ?>
