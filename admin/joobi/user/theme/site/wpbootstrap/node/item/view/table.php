...
if (!empty($elements)) : ?>
<table class="catalogItem badgeTable<?php echo $this->getContent('classSuffix'); ?>">
...
<tr class="<?php echo $TRclass; ?>">
	...
	<?php
		...
		if ( $elementParams->showVendor && !empty($element->vendorName) ) : echo '<br />' . $element->vendorBy . ': <a href="' . $element->vendorLink . '">' . $element->vendorName . '</a>' . ( !empty($element->syndicateVendorName) ? $element->syndicateVendorName : '' ); endif;
