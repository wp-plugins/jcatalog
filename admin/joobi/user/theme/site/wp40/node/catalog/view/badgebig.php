...
$colLeft = ( !empty( $imagePath ) ? 'col-sm-5' : 'col-xs-12' );
$colRight = ( !empty( $imagePath ) ? 'col-sm-7' : 'col-xs-12' );
?>
<div class="<?php echo $this->getContent('containerClass'); ?> catalogItem itemBig<?php echo $this->getContent('classSuffix'); ?>">
